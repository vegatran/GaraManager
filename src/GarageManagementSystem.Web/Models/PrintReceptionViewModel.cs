...
{
    /// <summary>
    /// View Model cho trang in biên bản tiếp nhận xe
    /// </summary>
    public class PrintReceptionViewModel
    {
        /// <summary>
        /// Dữ liệu phiếu tiếp đón
        /// </summary>
        public CustomerReceptionDto Reception { get; set; } = null!;
