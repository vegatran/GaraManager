...
namespace GarageManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251007064658_AddAlternativePhoneAndContactPerson")]
    partial class AddAlternativePhoneAndContactPerson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7711),
                            Department = "Kỹ thuật",
                            Email = "nguyenvana@garage.com",
                            HireDate = new DateTime(2023, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7696),
                            IsDeleted = false,
                            Name = "Nguyễn Văn A",
                            Phone = "0123456789",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7715),
                            Department = "Kỹ thuật",
                            Email = "tranthib@garage.com",
                            HireDate = new DateTime(2024, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7714),
                            IsDeleted = false,
                            Name = "Trần Thị B",
                            Phone = "0987654321",
                            Position = "Thợ lốp",
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bảo dưỡng",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7388),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "An toàn",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7391),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Lốp xe",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7393),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Sửa chữa",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 46, 57, 755, DateTimeKind.Local).AddTicks(7395),
