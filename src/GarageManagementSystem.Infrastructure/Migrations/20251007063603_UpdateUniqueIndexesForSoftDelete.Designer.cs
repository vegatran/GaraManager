...
namespace GarageManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251007063603_UpdateUniqueIndexesForSoftDelete")]
    partial class UpdateUniqueIndexesForSoftDelete
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(1716),
                            Department = "Kỹ thuật",
                            Email = "nguyenvana@garage.com",
                            HireDate = new DateTime(2023, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(1676),
                            IsDeleted = false,
                            Name = "Nguyễn Văn A",
                            Phone = "0123456789",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(1726),
                            Department = "Kỹ thuật",
                            Email = "tranthib@garage.com",
                            HireDate = new DateTime(2024, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(1719),
                            IsDeleted = false,
                            Name = "Trần Thị B",
                            Phone = "0987654321",
                            Position = "Thợ lốp",
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bảo dưỡng",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(838),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "An toàn",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(847),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Lốp xe",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(850),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Sửa chữa",
                            CreatedAt = new DateTime(2025, 10, 7, 13, 36, 0, 890, DateTimeKind.Local).AddTicks(852),
