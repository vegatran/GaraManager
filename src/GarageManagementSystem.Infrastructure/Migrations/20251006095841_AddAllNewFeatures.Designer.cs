...
namespace GarageManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251006095841_AddAllNewFeatures")]
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7872),
                            Department = "Kỹ thuật",
                            Email = "nguyenvana@garage.com",
                            HireDate = new DateTime(2023, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7858),
                            IsDeleted = false,
                            Name = "Nguyễn Văn A",
                            Phone = "0123456789",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7877),
                            Department = "Kỹ thuật",
                            Email = "tranthib@garage.com",
                            HireDate = new DateTime(2024, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7875),
                            IsDeleted = false,
                            Name = "Trần Thị B",
                            Phone = "0987654321",
                            Position = "Thợ lốp",
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bảo dưỡng",
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7577),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "An toàn",
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7580),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Lốp xe",
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7582),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Sửa chữa",
                            CreatedAt = new DateTime(2025, 10, 6, 16, 58, 41, 179, DateTimeKind.Local).AddTicks(7584),
