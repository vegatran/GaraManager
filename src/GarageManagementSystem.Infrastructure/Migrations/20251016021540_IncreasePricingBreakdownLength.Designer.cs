...
namespace GarageManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251016021540_IncreasePricingBreakdownLength")]
    partial class IncreasePricingBreakdownLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4203),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4204),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4206),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4207),
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4208),
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4210),
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4314),
                            Department = "Kỹ thuật",
                            Email = "nguyenvana@garage.com",
                            HireDate = new DateTime(2023, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4300),
                            IsDeleted = false,
                            Name = "Nguyễn Văn A",
                            Phone = "0123456789",
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4317),
                            Department = "Kỹ thuật",
                            Email = "tranthib@garage.com",
                            HireDate = new DateTime(2024, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4316),
                            IsDeleted = false,
                            Name = "Trần Thị B",
                            Phone = "0987654321",
                            Position = "Thợ lốp",
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Position", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4237),
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4238),
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4240),
                        ...
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4241),
                        ...
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4254),
                        ...
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4267),
                        ...
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4268),
                        ...
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4269),
                        ...
                        {
                            Id = 9,
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4271),
            ...
            modelBuilder.Entity("GarageManagementSystem.Core.Entities.Service", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Category = "Bảo dưỡng",
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4053),
                        ...
                        new
                        {
                            Id = 2,
                            Category = "An toàn",
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4056),
                        ...
                        new
                        {
                            Id = 3,
                            Category = "Lốp xe",
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4058),
                        ...
                        new
                        {
                            Id = 4,
                            Category = "Sửa chữa",
                            CreatedAt = new DateTime(2025, 10, 16, 9, 15, 39, 643, DateTimeKind.Local).AddTicks(4060),
