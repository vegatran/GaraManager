...
namespace RunDemoDataWithErrorCheck
{
    class Program
    {
        static void Main(string[] args)
        {
            string connectionString = "server=171.244.51.92;port=33061;database=GaraManagement;user=root;password=Abc@123456;AllowUserVariables=True;";
